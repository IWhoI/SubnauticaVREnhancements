...
namespace VREnhancements
{
    public class MainPatcher
    {
        ...
        public static void MCC_Update_Postfix(MainCameraControl __instance)
        {
            ...
            //I also moved the model forward at the same time. So I maintain my own closing state with pdaIsClosing and only move the model forward after pdaCloseDelay. There may be a better way to solve this.
